...
check_message("Hey, are we still meeting at the cafe in Thrissur tomorrow?")

# Test 2: A classic spam structure
check_message("URGENT! You have won a $1000 Walmart gift card. Click here to claim your prize now!")

# Test 3: A tricky banking scam
check_message("Bank Alert: Your account has been temporarily suspended due to suspicious activity. Please verify your identity at link.")